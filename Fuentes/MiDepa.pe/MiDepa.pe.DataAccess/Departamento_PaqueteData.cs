...
{
    public class Departamento_PaqueteData
    {
        ...
        public static int ObtenerCantidad(int depaId)
        {
            ...
            try
            {
                using (SqlConnection con = objDatabase.CrearConexion())
                {
                    ...
                    try
                    {
                        cmd = objDatabase.ObtenerProcedimiento("dbo.sp_Departamento_Paquete_ObtenerCantidadPorDepa");
