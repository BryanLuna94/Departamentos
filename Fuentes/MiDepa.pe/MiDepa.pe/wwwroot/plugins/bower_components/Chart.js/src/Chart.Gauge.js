(function(){
    ...
    Chart2.Line = Chart2.Element.extend({
        draw: function() {
            var ctx = this.ctx;
    ...
    Chart2.Type.extend({
        ...
        initialize:  function(data){
            ...
            this.pointerDot = new Chart2.Point({
                ctx: this.chart.ctx,
                x : this.chart.width/2,
            ...
            this.pointerLine = new Chart2.Line({
                ctx: this.chart.ctx,
                x: this.chart.width/2,
                // adjusting for the stroke width by subtracting pointer stroke size
                y: this.chart.height - pointerDotRadius - this.options.pointerStrokeSize,
        ...
        inRange : function(chartX,chartY, segment){
            ...
            // helpers.getAngleFromPoint assumes Chart2.Arc to start from PI/2 (90Deg)
